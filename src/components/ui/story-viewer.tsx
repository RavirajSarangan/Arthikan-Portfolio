...
function StoryThumbnail({
    ...
    return (
        ...
        >
            <div className="relative w-[72px] h-[72px]">
                ...
                >
                    {stories.map((_, index) => {
                        ...
                        const radius = 46;
                        const x1 = Math.round((50 + radius * Math.cos(startRad)) * 100) / 100;
                        const y1 = Math.round((50 + radius * Math.sin(startRad)) * 100) / 100;
                        const x2 = Math.round((50 + radius * Math.cos(endRad)) * 100) / 100;
                        const y2 = Math.round((50 + radius * Math.sin(endRad)) * 100) / 100;
                ...
                <div className="absolute inset-[5px] rounded-full bg-black p-[2px]">
                    <div className="w-full h-full rounded-full overflow-hidden bg-neutral-900 border border-white/5">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-500 group-hover:text-white transition-colors truncate max-w-[80px]">
                {username}
            </span>
        </button>
    );
        ...
        <div className="flex gap-1 w-full px-2">
            {Array.from({ length: count }).map((_, index) => {
                ...
                return (
                    <div
                        key={index}
                        className="flex-1 h-0.5 bg-white/10 rounded-full overflow-hidden"
                    >
                        <motion.div
...
function StoryViewerModal({
    ...
    return (
        <motion.div
            className="fixed inset-0 z-50 bg-black flex items-center justify-center p-0 md:p-6 lg:p-12"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
        ...
        >
            ...
            <div className="absolute inset-0 z-0">
                <img src={currentStory.src} className="w-full h-full object-cover blur-[100px] opacity-20" alt="" />
            </div>

            <motion.div
                ref={containerRef}
                className="relative w-full h-full max-w-sm md:aspect-[9/16] md:h-auto mx-auto flex flex-col overflow-hidden bg-neutral-950 md:rounded-[40px] shadow-2xl border border-white/5"
            ...
            >
                <div className="absolute top-0 left-0 right-0 z-10 pt-6 pb-12 bg-gradient-to-b from-black/80 to-transparent">
                    <ProgressBar
                    ...
                    <div className="flex items-center justify-between px-6 mt-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col">
                                <span className="text-white text-[11px] font-black uppercase tracking-widest">{username}</span>
                                {timestamp && (
                        ...
                        <div className="flex items-center gap-3">
                            {isPaused && (
                                <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-white/60">
                                    <Pause className="w-3 h-3" />
                                    <span className="text-[9px] font-black uppercase tracking-widest">Paused</span>
                                </div>
                            )}
                            ...
                            {currentStory.type === "video" && (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        "h-10 w-10 text-white hover:bg-white/20 transition-all",
                ...
                <div className="hidden lg:flex absolute inset-y-0 -left-16 -right-16 items-center justify-between pointer-events-none px-4">
                    <button
                        type="button"
                        className={cn(
                            "inline-flex items-center justify-center",
                            "h-12 w-12 rounded-full glass text-white hover:bg-white/20 transition-all pointer-events-auto",
                            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent",
                            "disabled:invisible",
