...
export function ImageLightbox({
    ...
    useEffect(() => {
        if (isOpen && currentIndex !== internalIndex && !isSliding) {
            setSlideDirection(currentIndex > internalIndex ? "left" : "right")
            ...
            <div
                ...
                style={{
                    transform: isVisible
                        ...
                        : `translateY(${-20 - index * 5}px) translateX(${translations[index] * 0.2}px) rotate(${rotations[index] * 0.5}deg) scale(0.8)`,
                    opacity: isSelected ? 0 : isVisible ? 1 : 0.4,
